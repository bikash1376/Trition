...
**Current phase: fixed a real bug — adding a Table block silently created a second, independently-navigable "page" in the sidebar (its embedded-table backing list had nothing marking it as non-navigable) — plus Databuddy analytics wired in. See Phase 35.**
